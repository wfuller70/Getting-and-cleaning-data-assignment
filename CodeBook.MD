...
This document describes the dataset used and the variables, data, and any code used to perform the task of tidying up the data as required in the Getting and cleaning data assignment. 
